.PHONY: clean clean-test clean-pyc clean-build docs help build-binary open-coverage-report
.DEFAULT_GOAL := help
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source git_open -m pytest
	coverage report -m
	coverage html
...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/git_open.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ git_open
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
